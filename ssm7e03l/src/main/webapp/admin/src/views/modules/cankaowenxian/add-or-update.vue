<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="文献名称" prop="wenxianmingcheng">
          <el-input v-model="ruleForm.wenxianmingcheng" 
              placeholder="文献名称" clearable  :readonly="ro.wenxianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="文献名称" prop="wenxianmingcheng">
              <el-input v-model="ruleForm.wenxianmingcheng" 
                placeholder="文献名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="文献分类" prop="wenxianfenlei">
          <el-input v-model="ruleForm.wenxianfenlei" 
              placeholder="文献分类" clearable  :readonly="ro.wenxianfenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="文献分类" prop="wenxianfenlei">
              <el-input v-model="ruleForm.wenxianfenlei" 
                placeholder="文献分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                                                  ...
                                                                  <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="文献附件" prop="wenxianfujian">
          <file-upload
          tip="点击上传文献附件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.wenxianfujian?ruleForm.wenxianfujian:''"
          @change="wenxianfujianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.wenxianfujian" label="文献附件" prop="wenxianfujian">
            <el-button type="text" size="small" @click="download(ruleForm.wenxianfujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `cankaowenxian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.cankaowenxianCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
				...
				this.addEditUploadStyleChange()
                                            ...
                                            wenxianfujianUploadChange(fileUrls) {
                this.ruleForm.wenxianfujian = fileUrls;
				this.addEditUploadStyleChange()
            },
                        	addEditStyleChange() {
	  this.$nextTick(()=>{
